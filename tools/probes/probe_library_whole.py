...
(acceptance/2026-09-14-library-names), then slot 1 copied into a fresh
...
# The run after finding 292's II.0 names; the 2026-09-12 library-complete and
# library-librarian runs are the same bytes from the placeholder-named source.
RUN = ROOT / "acceptance" / "2026-09-14-library-names" / "LIBLIB.CODE"
COMPILE = ROOT / "acceptance" / "2026-09-14-library-names"
